...
|---|---:|---|
| ✅ Concluídas | 20 | P01 a P16, P18, P20, P21 e P22 |
| 🟡 Em andamento | 2 | P17 e P19 |
| 🟢 Disponíveis | 0 | — |
| 🔴 Bloqueadas | 4 | P23 a P25 e P27 |
| ⚪ Planejada | 1 | P26 |

O avanço por quantidade de partes é de **20 concluídas em 27 (aproximadamente 74%)**. Esse percentual representa o número de partes concluídas, não o esforço total, pois banco de dados, integrações, segurança e publicação possuem complexidades diferentes. O AJ-001 foi concluído como reforço de segurança de partes existentes e, por isso, não altera a contagem das 27 partes principais.
...
P09, P14, P15, **P16 — Relatórios**, o **P18 — Banco de dados inicial**, o **P20 — Perfis e permissões**, o **P21 — Conexão das telas**, a **P22 — Auditoria** e o ajuste **AJ-001 — Conferência visual protegida** já foram concluídos. **P17 — Administração** e **P19 — Login real** seguem em andamento com Vinicius. Sem interferir no trabalho dele, o próximo ajuste disponível para Lucas é o **AJ-002 — Revelação controlada de CPF/documento**. P23 a P25 continuam bloqueadas até a equipe definir e disponibilizar os equipamentos físicos; P27 depende da P26, que está planejada para a validação final.
