...
P09, P14, P15, o **P18 — Banco de dados inicial** (fundação multi-implantação e os grupos Imóveis, Pessoas, Vínculos, Veículos e Usuários/Perfis/Permissões) e agora o **P20 — Perfis e permissões** (catálogo real de perfis e rotas internas protegidas) já foram concluídos. **P19 — Login real** segue em andamento com Vinicius. As demais partes (P16, P17, P21 a P25 e P27) seguem bloqueadas por dependência, e a P26 está apenas planejada.
