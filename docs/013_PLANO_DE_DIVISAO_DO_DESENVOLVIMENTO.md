...
O avanço por quantidade de partes é de **20 concluídas em 27 (aproximadamente 74%)**. Esse percentual representa o número de partes concluídas, não o esforço total, pois banco de dados, integrações, segurança e publicação possuem complexidades diferentes.
...
| P20 | Perfis e permissões | Definir o que porteiro/caixa, gestor, auditor e administrador podem fazer, e proteger as rotas internas | P18 e P19 | ✅ Concluída — catálogo real dos 4 perfis definidos pelo PO (`PORTEIRO_CAIXA`, `GESTOR`, `AUDITOR`, `ADMINISTRADOR`) e proteção das rotas internas com autenticação mais permissão específica. A P22 ampliou o catálogo de 25 para 27 permissões, adicionando `auditoria.consultar` e `auditoria.exportar` somente aos perfis Auditor e Administrador. Permanece fora deste escopo o contexto operacional Portaria/Caixa (troca de tela sem novo login) | Vinicius | [`vinicius/p20-perfis-permissoes`](https://github.com/remotevelaskoo/SDV-SANTARITA/pull/30), [`vinicius/p20-protecao-rotas`](https://github.com/remotevelaskoo/SDV-SANTARITA/pull/31) |
...
P09, P14, P15, **P16 — Relatórios**, o **P18 — Banco de dados inicial**, o **P20 — Perfis e permissões**, o **P21 — Conexão das telas** e a **P22 — Auditoria** já foram concluídos. **P17 — Administração** e **P19 — Login real** seguem em andamento com Vinicius. P23 a P25 continuam bloqueadas até a equipe definir e disponibilizar os equipamentos físicos; P27 depende da P26, que está planejada para a validação final.
