...
| 1.0.5 | 29/07/2026 | Soluções do Vale | Vinculação da proposta do ADR-003 ao catálogo |
| 1.0.6 | 30/07/2026 | Product Owner | Registro da aprovação do ADR-003 |
| 1.0.7 | 30/07/2026 | Soluções do Vale | Vinculação da proposta do ADR-004 ao catálogo |
...
| [ADR-005](ADR-005_FILAS_CACHE_LOCKS_E_IDEMPOTENCIA.md) | Filas, cache, locks e idempotência | P0 | Proposto | 010, 011 | processamento assíncrono |
