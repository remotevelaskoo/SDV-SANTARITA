...
class PreRegistrationQueue extends Component
{
    ...
    public array $records = [
        ...
        ['id' => 3, 'name' => 'Renata Alves', 'initials' => 'RA', 'type' => 'Turista', 'document' => '***.***.218-**', 'submittedAt' => '10/08/2026 às 10:15', 'vehicle' => 'Sem veículo', 'protocol' => 'PRE-SRA-C2P5T8', 'status' => 'correcao', 'destination' => 'Bloco C · Apto 501', 'responsible' => 'Rafael Domingues', 'period' => '12/08 a 16/08/2026', 'alert' => 'Selfie precisa ser reenviada'],
