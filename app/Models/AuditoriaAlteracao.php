...
#[Fillable(['auditoria_evento_id', 'field_name', 'old_value', 'new_value', 'classification', 'is_masked'])]
class AuditoriaAlteracao extends Model
{
    use HasUuids;

    public $timestamps = false;

    protected $table = 'auditoria_alteracoes';
