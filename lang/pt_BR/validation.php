...
return [
    ...
    | classe de validação. O projeto usa pt_BR como locale (ver
    | docs/000_DIRETRIZES_DO_PROJETO.md e APP_LOCALE em .env.example),
    | mas o framework não publica traduções por padrão.
    |
    */
    ...
    'uploaded' => 'Ocorreu uma falha ao enviar o arquivo do campo :attribute.',
    ...
    |--------------------------------------------------------------------------
    |
    | Usadas para mensagens específicas por atributo.rule, ex: 'documento.required'.
    |
    */
